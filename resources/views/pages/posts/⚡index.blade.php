...
new class extends Component
{
    ...
    {
        //authorize
        if(auth()->user()->can('delete all posts') || auth()->user()->can('delete own posts') && $post->user_id === auth()->user()->id){
            $post->delete();
...
<div>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Manage you blog posts</p>
    </div>
